...
public class BookService {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(BOOKS_FILE))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (bookData.length == 5) {
                    ...
                    LocalDate dueDate = LocalDate.parse(bookData[3].trim());
                    double lateFee = Double.parseDouble(bookData[4].trim());
                    books.add(new Book(title, author, isbn, dueDate, lateFee));
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    // Search books
    public List<Book> searchBooks(String isbn, String title, String author) {
        List<Book> books = loadBooks();
        return books.stream()
    ...
    public List<Book> searchBooks(String searchText) {
        return searchBooks(searchText, searchText, searchText);
    }
